...
/// Create a component following my theme of the login and sign up page I want
/// to create a component so when they press the reset the password button
/// this comes up an they can typer the email to where the reset option should
/// be sent
